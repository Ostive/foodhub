...
export default function Hero() {
  return (
    <section className="relative w-full flex flex-col items-center justify-center min-h-[90vh] md:min-h-screen overflow-hidden -mt-px">
      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col items-start text-left pt-32 md:pt-40">
        ...
        <div className="w-full max-w-2xl mb-12 animate-fade-in delay-150">
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-14 pr-24 py-5 border-2 border-white/80 rounded-full bg-white/95 backdrop-blur-md focus:ring-[#4CAF50] focus:border-[#4CAF50] focus:outline-hidden shadow-lg text-[#212121] text-lg"
            />
        ...
        <div className="flex flex-wrap gap-3 max-w-3xl animate-fade-in delay-300">
          {[
            ...
            <span 
              key={idx} 
              className="px-5 py-2 bg-white/20 backdrop-blur-xs text-white rounded-full text-base font-medium hover:bg-white/30 cursor-pointer transition-colors"
